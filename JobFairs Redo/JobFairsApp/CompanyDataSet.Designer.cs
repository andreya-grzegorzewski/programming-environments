...
namespace JobFairsApp {
    ...
    public partial class CompanyDataSet : global::System.Data.DataSet {
        ...
        public partial class CompaniesDataTable : global::System.Data.TypedTableBase<CompaniesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public CompaniesRow AddCompaniesRow(string Name, string Address1, string Address2, string City, string State, string Zip, string Website) {
        ...
        public partial class CompaniesRow : global::System.Data.DataRow {
            ...
            public string Zip {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Zip\' in table \'Companies\' is DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsZipNull() {
                return this.IsNull(this.tableCompanies.ZipColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetZipNull() {
                this[this.tableCompanies.ZipColumn] = global::System.Convert.DBNull;
            }
...
namespace JobFairsApp.CompanyDataSetTableAdapters {
    ...
    public partial class CompaniesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Companies] WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Name) AND ((@IsNull_Address1 = 1 AND [Address1] IS NULL) OR ([Address1] = @Original_Address1)) AND ((@IsNull_Address2 = 1 AND [Address2] IS NULL) OR ([Address2] = @Original_Address2)) AND ((@IsNull_City = 1 AND [City] IS NULL) OR ([City] = @Original_City)) AND ((@IsNull_State = 1 AND [State] IS NULL) OR ([State] = @Original_State)) AND ((@IsNull_Zip = 1 AND [Zip] IS NULL) OR ([Zip] = @Original_Zip)) AND ((@IsNull_Website = 1 AND [Website] IS NULL) OR ([Website] = @Original_Website)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Companies] ([Name], [Address1], [Address2], [City], [State], [Zip], [Website]) VALUES (@Name, @Address1, @Address2, @City, @State, @Zip, @Website);
SELECT ID, Name, Address1, Address2, City, State, Zip, Website FROM Companies WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Companies] SET [Name] = @Name, [Address1] = @Address1, [Address2] = @Address2, [City] = @City, [State] = @State, [Zip] = @Zip, [Website] = @Website WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Name) AND ((@IsNull_Address1 = 1 AND [Address1] IS NULL) OR ([Address1] = @Original_Address1)) AND ((@IsNull_Address2 = 1 AND [Address2] IS NULL) OR ([Address2] = @Original_Address2)) AND ((@IsNull_City = 1 AND [City] IS NULL) OR ([City] = @Original_City)) AND ((@IsNull_State = 1 AND [State] IS NULL) OR ([State] = @Original_State)) AND ((@IsNull_Zip = 1 AND [Zip] IS NULL) OR ([Zip] = @Original_Zip)) AND ((@IsNull_Website = 1 AND [Website] IS NULL) OR ([Website] = @Original_Website)));
SELECT ID, Name, Address1, Address2, City, State, Zip, Website FROM Companies WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Address1, Address2, City, State, Zip, Website FROM dbo.Companies" +
                "";
        ...
        public virtual int Fill(CompanyDataSet.CompaniesDataTable dataTable) {
        ...
        public virtual CompanyDataSet.CompaniesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CompanyDataSet.CompaniesDataTable dataTable = new CompanyDataSet.CompaniesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CompanyDataSet.CompaniesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_Name, string Original_Address1, string Original_Address2, string Original_City, string Original_State, string Original_Zip, string Original_Website) {
        ...
        public virtual int Insert(string Name, string Address1, string Address2, string City, string State, string Zip, string Website) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Address1, string Address2, string City, string State, string Zip, string Website, int Original_ID, string Original_Name, string Original_Address1, string Original_Address2, string Original_City, string Original_State, string Original_Zip, string Original_Website) {
            return this.Update(Name, Address1, Address2, City, State, Zip, Website, Original_ID, Original_Name, Original_Address1, Original_Address2, Original_City, Original_State, Original_Zip, Original_Website, Original_ID);
        }
    }
